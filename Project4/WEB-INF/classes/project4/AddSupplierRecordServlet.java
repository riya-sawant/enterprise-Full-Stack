...
public class AddSupplierRecordServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
	{
		...
		try {
			...
			String sqlStatement = "insert into suppliers values (\"" + snum + "\",\"" + sname + "\",\"" + status + "\",\"" + city + "\")";
			val1 = statement.executeUpdate(sqlStatement);	

			message = "<div style='background-color:#32CD32'><b>New suppliers record: (" + snum + ", " + sname + ", " + status + ", " + city + ") - sucessfully entered into database.<br><br>";
