...
public class AddPartsRecordServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
	{
		...
		try {
			...
			String sqlStatement = "insert into parts values (\"" + pnum + "\",\"" + pname + "\",\"" + color + "\",\"" + weight + "\",\"" + city + "\")";
			val1 = statement.executeUpdate(sqlStatement);	

			message = "<div style='background-color:#32CD32'><b>New parts record: (" + pnum + ", " + pname + ", " + color + ", " + weight + ", " + city + ") - sucessfully entered into database.<br><br>";
